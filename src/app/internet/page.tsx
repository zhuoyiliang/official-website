...
const msg2 = "科室医生通过PC端或移动端，利用在线视频、语音、图文的形式为复诊、图文咨询、视频咨询患者提供线上门诊诊疗服务，方便患者利用移动端随时随地找医生问诊。通过对接医院HIS系统，将患者的病历信息、医嘱信息、检验检查等诊疗数据进行整合，有助于实现互联网医院与医院信息系统数据的高度共享和互联互通，从而便于医生在互联网诊疗中经患者授权下调阅就诊历史。"
...
export default function Page() {
  return (
    <div>
      ...
      <div className="container my-12 mx-auto lg:px-56 flex items-center gap-4">
        <img
          src="/images/internet/image1.png"
          alt=""
          className="rounded-xl p-6 transition-all duration-300"
        />
        <p className=" indent-8">{msg2}</p>
      </div>
    </div>
  );
}
